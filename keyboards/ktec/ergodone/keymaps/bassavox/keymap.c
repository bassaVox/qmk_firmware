...
#define DONTQY 0 // default layer
#define QWERTY 1 // qwerty for the faint of heart
...
[QWERTY] = LAYOUT_ergodox(
        // left hand
                        ...
                        _______,        KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   KC_EXLM,
                        _______,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
                        _______,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   KC_MINS,
                        _______,        _______,      _______,_______,_______,
                                                                                   _______,  _______,
                                                                                             _______,
                                                                          _______, _______,  _______,
        // right hand
                        TO(DONTQY),  _______,      _______,_______,_______,_______,   _______,
                        _______,        KC_Y,         KC_U,   KC_I,   KC_O,   KC_P,   _______,
                                        KC_H,         KC_J,   KC_K,   KC_L,   LT(SYMBOL,BR_CCED), _______,
                        _______,        KC_N,         KC_M,   KC_COMM,KC_DOT, BR_SCLN,KC_RSFT,
                                                      _______,_______,_______,_______,_______,
                        _______,_______,
                        _______,
                        _______,_______,_______
